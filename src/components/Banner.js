...
//   return (
//     <Box textAlign="center"  mb="2" bg='' mx="auto">
//       {/* Promotional Banner */}
...
//   { id: 1, image: 'https://img.theloom.in/pwa/loom/banners/14sep-2024-Ganesh-Chaturthi-Sale-3840-1500-Main-Desktop-Banner.jpg?tr=h-624%2Cw-1600', title: 'Featured Product 1' },
//   { id: 2, image: 'https://img.theloom.in/pwa/loom/banners/11sep-2024-Festive-New-Launches-Desktop-Banner.jpg?tr=h-624%2Cw-1600', title: 'Featured Product 2' },
//   { id: 3, image: 'https://img.theloom.in/pwa/loom/banners/12sep-2024-LoomExclusive-Desktop_MainBanner.png?tr=h-624%2Cw-1600', title: 'Featured Product 3' },
// ];
...
//   return (
//     <Box textAlign="center" mb="2" mx="auto" width="100%" maxWidth="75rem">
//       {/* Promotional Banner */}
//       <Box p="4" bg={promotions[0].bg}>
//         <Text
//           fontSize={{ base: "1.5rem", md: "2rem", lg: "3rem" }} // Using rem for font size
//           fontWeight="bold"
//         >
//           {promotions[0].text}
//         </Text>
...
//       {/* Image Slider */}
//       <Box mt="4" width="100%" bg="#ffbb70" mx="auto" maxWidth="100%">
//         <Slider {...settings}>
//           {featuredProducts.map((item) => (
//             <Box key={item.id}>
//               <Image
...
//                 objectFit="cover"
//                 width="100%"
//                 height={{ base: "12.5rem", md: "25rem", lg: "31.25rem" }} // Using rem for height
//               />
//             </Box>
//           ))}
//         </Slider>
