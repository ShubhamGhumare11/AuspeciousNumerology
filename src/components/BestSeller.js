...
//       bgGradient="linear-gradient(180deg, #f7c94b 0%, #f4939f 100%)"
//     >
//       <Flex alignItems="center" justifyContent="center" mb="0.50rem">
//         <Box width="6rem" height="6rem">
//           <Lottie animationData={boxanimation} />
//         </Box>
//         <Text fontSize="2.5rem" fontWeight="bold" mb="0.50rem">
//           BESTSELLERS
//         </Text>
...
//         <Slider {...settings}>
//           {bestSellers.map((item) => (
//             <Box key={item.id} textAlign="center" p="1rem">
//               <Image src={item.image} alt={item.title} borderRadius="0.5rem" />
...
//         </Slider>
//       </Box>
//       <Button mt="2rem" colorScheme="blackAlpha" variant="solid" size="lg">
//         Shop Bestsellers
//       </Button>
//     </Box>
//   );
